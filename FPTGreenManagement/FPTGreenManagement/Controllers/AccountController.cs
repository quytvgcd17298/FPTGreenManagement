...
namespace FPTGreenManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        public ActionResult CreateTrainerLogin()
        {
            return View();
        }
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost]
        public async Task<ActionResult> CreateTrainerLogin(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpGet]
        public ActionResult CreateTraineeLogin()
        {
            return View();
        }
        ...
        [Authorize(Roles = "Staff")]
        [HttpPost]
        public async Task<ActionResult> CreateTraineeLogin(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        [Authorize(Roles = "Admin")]
        [HttpGet]
        public ActionResult CreateStaffLogin()
        {
            return View();
        }
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost]
        public async Task<ActionResult> CreateStaffLogin(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        public async Task<ActionResult> ResetStaffPassword(string id)
        {
            ...
            return RedirectToAction("GetStaff   s", "Admin");
